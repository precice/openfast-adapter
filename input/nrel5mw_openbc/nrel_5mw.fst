...
NREL 5.0 MW Baseline Wind Turbine coupled to preCICE
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"NREL_5MW/ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"NREL_5MW/BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"NREL_5MW/BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"NREL_5MW/BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"unused"      InflowFile        - Name of file containing inflow wind input parameters (quoted string)
"NREL_5MW/AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
      ...
      99999   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
       1.50   DT_Out          - Time step for tabular output (s) (or "default")
